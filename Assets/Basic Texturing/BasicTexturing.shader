Shader "CGBasicTexturing/TextureShaded" {
	Properties {
	...
	SubShader {
		Pass {	
			...
			float4 frag(vertexOutput input) : COLOR
			{
				...
				// offset and tiling feature is usually not implemented in order to keep the shader code a bit cleaner. And just for completeness.
			}
